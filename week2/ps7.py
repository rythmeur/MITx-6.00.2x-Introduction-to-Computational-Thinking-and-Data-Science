...
class RectangularRoom(object):
    ...
    def __init__(self, width, height):
        ...
        self.height=height
        self.cleaned={}
        self.cleaned = {(i,j): False for i in range(self.width) for j in range(self.height)}
    ...
    def cleanTileAtPosition(self, pos):
        ...
        pos_rounded=( math.floor(pos.getX()), math.floor(pos.getY()) )
        if pos.getX() <self.width and pos.getY() < self.height:
            self.cleaned[pos_rounded] = True
            #print "pos", pos
            #print "pos_rounded", pos_rounded
    ...
    def getNumCleanedTiles(self):
        ...
        return len ([i for i in (self.cleaned.values()) if i == True])
...
class StandardRobot(Robot):
    ...
    #while True:
        ...
        next_position=self.position.getNewPosition(self.direction,self.speed)
...
def runSimulation(num_robots, speed, width, height, min_coverage, num_trials,
    ...
    while count_trials<num_trials:
        ...
        num_steps=0
        robots_list=[]
        for i in range(num_robots): #reset new robots
        ...
        trials_results.append(num_steps)
        anim.done()
    return sum(trials_results)*1.0/len(trials_results)
...
class RandomWalkRobot(Robot):
    ...
    def updatePositionAndClean(self):
        ...
        been cleaned.
        """
        new_angle=random.uniform(0,270)

        self.direction=(self.direction+new_angle)%360
        ...
        if self.room.isPositionInRoom(next_position):
            ...
            self.position=next_position
#        else:
#            self.direction=random.uniform((self.direction-45)%360, (self.direction+45)%360)

avg = runSimulation(1, 1.0, 5, 5, 0.8, 1, RandomWalkRobot)
print avg
# === Problem 5
#
...
def showPlot2(title, x_label, y_label):
    ...
    for width in [10, 20, 25, 50]:
        ...
        times1.append(runSimulation(2, 1.0, width, height, 0.8, 1, StandardRobot))
        times2.append(runSimulation(2, 1.0, width, height, 0.8, 1, RandomWalkRobot))
